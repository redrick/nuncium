RSpec.describe Nuncium::WebServices::DbSearch::CheckDataBox do
  it_behaves_like 'web service'

  describe '#to_xml' do
    it 'expects correctly formatted xml request' do
      web_service = Nuncium::WebServices::DbSearch::CheckDataBox.new
  ...
  describe '#call' do
    it 'receives correct response from API' do
      web_service = Nuncium::WebServices::DbSearch::CheckDataBox
