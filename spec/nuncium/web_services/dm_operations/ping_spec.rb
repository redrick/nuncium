RSpec.describe Nuncium::WebServices::DmOperations::Ping do
  it_behaves_like 'web service'

  describe '#to_xml' do
    it 'expects correctly formatted xml request' do
      web_service = Nuncium::WebServices::DmOperations::Ping.new
  ...
  describe '#call' do
    it 'receives correct response from API' do
      ...
      VCR.use_cassette 'web_services/dm_operations/ping' do
        ...
        expect(result).to be_a(Nuncium::WebServices::DmOperations::Response)
