RSpec.describe Nuncium::WebServices::DmInfo::GetMessageAuthor do
  it_behaves_like 'web service'

  describe '#to_xml' do
    it 'expects correctly formatted xml request' do
      web_service = Nuncium::WebServices::DmInfo::GetMessageAuthor.new
  ...
  describe '#call' do
    it 'receives correct response from API' do
      web_service = Nuncium::WebServices::DmInfo::GetMessageAuthor.new(dmID: '6495272')
