RSpec.describe Nuncium::WebServices::DmInfo::GetListOfReceivedMessages do
  it_behaves_like 'web service'

  describe '#to_xml' do
    it 'expects correctly formatted xml request' do
      web_service = Nuncium::WebServices::DmInfo::GetListOfReceivedMessages.new
  ...
  describe '#call' do
    it 'receives correct response from API' do
      ...
      VCR.use_cassette 'web_services/dm_info/get_list_of_received_messages' do
        ...
        expect(result).to be_a(Nuncium::Responses::Messages::Collection)
        ...
        expect(result.messages.first).to be_a(Nuncium::DataMessage)
      end
    end
  end
end
