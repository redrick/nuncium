RSpec.describe Nuncium::WebServices::DmInfo::VerifyMessage do
  it_behaves_like 'web service'

  describe '#to_xml' do
    it 'expects correctly formatted xml request' do
      web_service = Nuncium::WebServices::DmInfo::VerifyMessage.new
  ...
  describe '#call' do
    it 'receives correct response from API' do
      web_service = Nuncium::WebServices::DmInfo::VerifyMessage.new(dmID: '6495272')
